...
class ParquetIO {
    ...
    private static final Logger logger_ =
        LoggerFactory.getLogger( ParquetIO.class );
    ...
    public StarTable readParquet( DataSource datsrc,
        ...
        if ( useCache ) {
            ...
            try {
                ...
                logger_.warn("Cached read failed for " + datsrc, e );
            }
        }
    ...
    private static InputFile createInputFile( DataSource datsrc,
        ...
        /* A URL might work, who knows? */
            ...
            if ( tryUrl ) {
                logger_.warn( datsrc + " doesn't look like a local file: "
     ...
     *
     * @param bldr configuration object
     */
