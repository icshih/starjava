 ...
 */
public class CoosysTest {

    static final Logger logger = LoggerFactory.getLogger(CoosysTest.class);

    private static final StoragePolicy storage_= StoragePolicy.PREFER_MEMORY;
    private static final StarTableFactory tfact_ = new StarTableFactory();
