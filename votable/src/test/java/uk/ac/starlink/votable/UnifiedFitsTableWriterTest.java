...
public class UnifiedFitsTableWriterTest {

    final static Logger logger = LoggerFactory.getLogger( UnifiedFitsTableWriterTest.class );
    private final static StarTableOutput sto_ = new StarTableOutput();
