...
public class FitsPlusTest {

    static ColumnStarTable table_;
    static String longdesc =
        "My goodness this is a long-winded description for a column without " +
        "any very interesting content";

    static ColumnInfo COL1_INFO = new ColumnInfo( "col1", Integer.class, longdesc );
    static ValueInfo AUTHOR_INFO =
        new DefaultValueInfo( "Author", String.class, "Writer of the table" );
    static DescribedValue authorParam = new DescribedValue( AUTHOR_INFO, "Beauchamp" );
