 ...
 * @see HdxDocument
 */
class HdxNode implements Node, Cloneable {
     ...
     * Node#cloneNode documentation}, here, the cloned node does
...
//     }
    ...
    public int hashCode() {
        ...
        HashCode hc = new HashCode(getNodeName().hashCode());
