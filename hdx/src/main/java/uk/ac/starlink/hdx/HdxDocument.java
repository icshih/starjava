 ...
 * @version $Id$
 */
public class HdxDocument extends HdxNode implements Document {
    ...
    public ProcessingInstruction createProcessingInstruction (String target, 
        ...
        class HdxProcessingInstruction
            ...
            public int hashCode() {
                return new HashCode(target.hashCode())
                        .add(data.hashCode())
                        .value();
            }
        }
...
//             return newel;
        ...
        public int hashCode() {
            return new HashCode(resourceType.hashCode())
    ...
    private class HdxText extends HdxCharacterData implements Text {
