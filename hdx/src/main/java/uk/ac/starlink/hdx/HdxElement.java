 ...
 * Element} interface (the sole exception is the
 ...
 * @version $Id$
 */
class HdxElement extends HdxNode implements Element, Cloneable {
...
//                                            hdxname.getPrefix());
     ...
     * {@link Element} documentation makes no
...
//DOM3     }
    ...
    public int hashCode() {
        ...
        // SortedMap.
        HashCode hc = new HashCode(giName.hashCode());
     ...
     * This implements the {@link Attr} interface.  Package-only class.
     *
     ...
     */
    private static final class HdxAttr extends HdxNode implements Attr {
