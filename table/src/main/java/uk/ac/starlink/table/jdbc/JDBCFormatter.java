...
public class JDBCFormatter {
     ...
     * @return   one of the {@link Types} codes
     */
     ...
     * JDBC type.
     * 
     * @param  sqlType  type id (as per {@link Types})
     ...
     * {@link Types} constant and the value is a string which
    ...
    public static class SqlColumn {
         ...
         *
         * @return  symbolic integer from {@link Types}
         */
